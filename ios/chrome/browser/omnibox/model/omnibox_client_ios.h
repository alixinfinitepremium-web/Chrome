...
#ifndef IOS_CHROME_BROWSER_OMNIBOX_MODEL_OMNIBOX_CLIENT_IOS_H_
#define IOS_CHROME_BROWSER_OMNIBOX_MODEL_OMNIBOX_CLIENT_IOS_H_
...
#import "components/omnibox/common/input_state.h"
...
class OmniboxClientIOS {
 public:
  OmniboxClientIOS() = default;
  virtual ~OmniboxClientIOS() = default;
  ...
  const bookmarks::BookmarkModel* GetBookmarkModel() const {
    return const_cast<OmniboxClientIOS*>(this)->GetBookmarkModel();
  }
  ...
  const TemplateURLService* GetTemplateURLService() const {
    return const_cast<OmniboxClientIOS*>(this)->GetTemplateURLService();
  }
  ...
  gfx::Image GetFaviconForPageUrl(
    ...
    return const_cast<OmniboxClientIOS*>(this)->GetFaviconForPageUrl(
  ...
  gfx::Image GetFaviconForDefaultSearchProvider(
      FaviconFetchedCallback on_favicon_fetched) const {
    return const_cast<OmniboxClientIOS*>(this)
        ->GetFaviconForDefaultSearchProvider(std::move(on_favicon_fetched));
  }
  ...
  gfx::Image GetFaviconForKeywordSearchProvider(
      ...
      FaviconFetchedCallback on_favicon_fetched) const {
    return const_cast<OmniboxClientIOS*>(this)
        ->GetFaviconForKeywordSearchProvider(template_url,
...
#endif  // IOS_CHROME_BROWSER_OMNIBOX_MODEL_OMNIBOX_CLIENT_IOS_H_
